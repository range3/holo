...
commander
  ...
  .option('-b, --before <number>', 'Print programs that started later than N minutes ago', Number, 10)
  .option('-a, --after <number>', 'Print programs whose broadcast start is earlier than N minutes later', Number, 180)
